...
- (void)viewDidLoad {
    ...
    _imageView = [[CourseImageView alloc]initWithFrame:@"Good!Time needs now" Btn:@"Next"];
...
- (void)timeFireMethod {
    ...
    if (timeCount == -1) {
        ...
        _imageView = [[CourseImageView alloc]initWithFrame:@"You already understand" Btn:@"Next"];
        [self.view addSubview:_imageView];
    }
}
